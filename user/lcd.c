...
static volatile unsigned int *b;
...
void POKE(unsigned int x, int y, int c)
{
	b[(y*3+144+0)*1024 + x*3+221+0] = c;
	b[(y*3+144+0)*1024 + x*3+221+1] = c;
	b[(y*3+144+0)*1024 + x*3+221+2] = c;
	b[(y*3+144+1)*1024 + x*3+221+0] = c;
	b[(y*3+144+1)*1024 + x*3+221+1] = c;
	b[(y*3+144+1)*1024 + x*3+221+2] = c;
	b[(y*3+144+2)*1024 + x*3+221+0] = c;
	b[(y*3+144+2)*1024 + x*3+221+1] = c;
	b[(y*3+144+2)*1024 + x*3+221+2] = c;
#if 0
	b[(y*4+0)*1024 + x*4+1] = c;
	b[(y*4+0)*1024 + x*4+2] = c;
	b[(y*4+0)*1024 + x*4+3] = c;

	b[(y*4+1)*1024 + x*4+0] = c;
	b[(y*4+1)*1024 + x*4+1] = c;
	b[(y*4+1)*1024 + x*4+2] = c;
	b[(y*4+1)*1024 + x*4+3] = c;

	b[(y*4+2)*1024 + x*4+0] = c;
	b[(y*4+2)*1024 + x*4+1] = c;
	b[(y*4+2)*1024 + x*4+2] = c;
	b[(y*4+2)*1024 + x*4+3] = c;

	b[(y*4+3)*1024 + x*4+0] = c;
	b[(y*4+3)*1024 + x*4+1] = c;
	b[(y*4+3)*1024 + x*4+2] = c;
	b[(y*4+3)*1024 + x*4+3] = c;
#endif
}
